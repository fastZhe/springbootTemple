var obj = {
    baseUrl :'../../assets/js',//配置根目录
    ctlBaseUrl : '/echod_manager/rest',//配置controller的baseurl
    reSourceBaseUrl : '../../assets/images/',//配置资源文件根目录
    ...
    shim:{
        ...
        'createTree' : {
            deps : [
                ...
                'tweenMax',
                'menu',
                'css!../../assets/js/plugins/searchtree/css/jquery-ui-1.10.3.custom.min',
                'css!../../assets/css/font/entypo/css/entypo',
                'css!../../assets/js/plugins/bootstrap/css/bootstrap',
                'css!../../assets/js/plugins/searchtree/css/neon-core',
                'css!../../assets/js/plugins/searchtree/css/neon-theme',
                'css!../../assets/js/plugins/searchtree/css/neon-forms'
            ]  
        },
        'daterangepicker' : {
            deps : [
                ...
                'moment',
                'css!../../assets/js/plugins/bootstrap/css/bootstrap',
                'css!../../assets/js/plugins/daterangepicker/daterangepicker'
            ]
        },
    }
} ;
